...
SchoolMosPy предоставляет простой и интуитивный интерфейс для взаимодействия с платформой МЭШ. Библиотека позволяет программно получать информацию об ученике, оценках, домашних заданиях, расписании, детальных уроках, питании, посещаемости, уведомлениях и подарках.
...
- **📚 Полнофункциональная** - Полный доступ к оценкам, домашним заданиям, событиям, деталям уроков, питанию, посещаемости, уведомлениям, подаркам и данным профиля
...
- [LessonScheduleClient](api/lesson_schedule.md) - Детальная информация об уроке
- [MealsClient](api/meals.md) - Получение школьного питания
- [EntrancesClient](api/entrances.md) - Получение времени пребывания в школе
- [InstantMessagesClient](api/instant_messages.md) - Получение уведомлений
- [GamificationClient](api/gamification.md) - Подарки МЭШ
